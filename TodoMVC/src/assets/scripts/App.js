...
class App extends DOMElement {
    ...
    create() {
        ...
        this._$addTodoInput = this.$element.find('.js-App-addInput');
    ...
    _onCreateTodo = function(event) {
        ...
        if (event.which === Key.ENTER && todoText != '') {
            let baseModel = new TodoModel({text: todoText});
    ...
    _onLoadedItems = function(event) {
        ...
        // Create ListItemComponent view items from the stored TodoModel  Base Models.
