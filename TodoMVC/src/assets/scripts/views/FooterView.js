...
class FooterView extends DOMElement {
    ...
    create() {
        ...
        this._$itemsCompleteText = this.$element.find('.js-FooterView-complete');
        this._$itemsRemainingText = this.$element.find('.js-FooterView-remaining');
        this._$clearCompleteButton = this.$element.find('.js-FooterView-clearCompleteBtn');
